...
namespace aire
{
    public partial class GF_SKYS_USA : Form
    {
        ado d = new ado();
        ...
        public void searchfromto()
        {
            ...
            {
                nameProc = "serchFROMTOskyCOPY1gglCOPY1";
            }
            else if (textBox1.Text == "" && textBox2.Text != "")
            {
                to = textBox2.Text;
                nameProc = "serchTOskyCOPY1gglCOPY1";
            }
            else if (textBox1.Text != "" && textBox2.Text == "")
            {
                nameProc = "serchFROMskyCOPY1gglCOPY1";
                fromm = textBox1.Text;
            }
        ...
        private void comb()
        {
            d.da = new SqlDataAdapter("select distinct [From] from tablXCOPY1", d.cn);
            d.da.Fill(d.ds, "com1");
            d.da = new SqlDataAdapter("select distinct [To] from tablXCOPY1", d.cn);
            d.da.Fill(d.ds, "com2");
        ...
        private void GF_SKYS_USA_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            d.cmdd.Parameters.Clear();
            d.cmdd.CommandType = CommandType.StoredProcedure;
            d.cmdd.CommandText = "serch1COPY1";
            ...
            if (checkBox1.Checked == true)/*google*/
            {
                if (checkBox3.Checked == true && checkBox4.Checked == false)/*new*/
                {
                    if (radioButton1.Checked == true && radioButton2.Checked == false && radioButton3.Checked == false)/*The price is greater than A*/
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "tablxgglebigCOPY1");
                    ...
                    else if (radioButton2.Checked == true && radioButton3.Checked == false && radioButton1.Checked == false)/*The price is less than A*/
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "tablxgglelessCOPY1");
                    ...
                    else if (radioButton3.Checked == true && radioButton2.Checked == false && radioButton1.Checked == false)/*between*/
                    {
                        ...
                        somme(float.Parse(A.Text), float.Parse(B.Text), "betweentablxABCOPY1");
                ...
                else if (checkBox3.Checked == false && checkBox4.Checked == true)/*diffe*/
                {
                    if (radioButton1.Checked == true && radioButton2.Checked == false && radioButton3.Checked == false)/*The price is greater than A*/
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "tablxggledifbigCOPY1");
                    ...
                    else if (radioButton2.Checked == true && radioButton3.Checked == false && radioButton1.Checked == false)/*The price is less than A*/
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "tablxgglediflessCOPY1");
                    ...
                    else if (radioButton3.Checked == true && radioButton2.Checked == false && radioButton1.Checked == false)/*between*/
                    {
                        ...
                        somme(float.Parse(A.Text), float.Parse(B.Text), "betweentablxABdifCOPY1");
            ...
            else if (checkBox2.Checked == true)/*skys*/
            {
                if (checkBox4.Checked == false && checkBox3.Checked == true)/*new*/
                {
                    ...
                    if (radioButton1.Checked == true && radioButton2.Checked == false && radioButton3.Checked == false)/*The price is greater than A*/
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "tablxskybigCOPY1");
                    ...
                    else if (radioButton2.Checked == true && radioButton3.Checked == false && radioButton1.Checked == false)/*The price is less than A*/
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "tablxskylessCOPY1");
                    ...
                    else if (radioButton3.Checked == true && radioButton2.Checked == false && radioButton1.Checked == false)/*between*/
                    {
                        ...
                        somme(float.Parse(A.Text), float.Parse(B.Text), "betweentablxABnewCOPY1");
                ...
                else if (checkBox3.Checked == false && checkBox4.Checked == true)/*diffe*/
                {
                    if (radioButton1.Checked == true && radioButton2.Checked == false && radioButton3.Checked == false)/*The price is greater than A*/
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "tablxskydifbigCOPY1");
                    ...
                    else if (radioButton2.Checked == true && radioButton3.Checked == false && radioButton1.Checked == false)/*The price is less than A*/
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "tablxskydiflessCOPY1");
                    ...
                    else if (radioButton3.Checked == true && radioButton2.Checked == false && radioButton1.Checked == false)/*between*/
                    {
                        ...
                        somme(float.Parse(A.Text), float.Parse(B.Text), "betweentablxABdifskyCOPY1");
            ...
            if (checkBox1.Checked == true && checkBox2.Checked == true)/*google and skys*/
            {
                ...
                if (checkBox4.Checked == true || checkBox3.Checked == true)/*new*/
                {
                    ...
                    if (radioButton4.Checked == true && radioButton5.Checked == false && radioButton6.Checked == false && checkBox4.Checked == true)
                    {
                        ...
                        d.cmdd.Parameters.Clear();
                        d.cmdd.CommandType = CommandType.StoredProcedure;
                        d.cmdd.CommandText = "NewpriceGFNewpriceSkysCOPY1";
                        d.cmdd.Connection = d.cn;
                    ...
                    else if (radioButton4.Checked == false && radioButton5.Checked == true && radioButton6.Checked == false && checkBox4.Checked == true)
                    {
                        ...
                        d.cmdd.Parameters.Clear();
                        d.cmdd.CommandType = CommandType.StoredProcedure;
                        d.cmdd.CommandText = "DifferenceGFDifferenceSkysCOPY1";
                        d.cmdd.Connection = d.cn;
                    ...
                    else if (radioButton4.Checked == false && radioButton5.Checked == false && radioButton6.Checked == true && checkBox3.Checked == true)
                    {
                        ...
                        somme(float.Parse(A.Text), 99999, "NewpriceGFSKYSlessthanACOPY1");
                        dtgrdvwcolor();
                    }
                }
        ...
        private void cabintablX()
        {
            ...
            d.cmdd.Parameters.Clear();
            d.cmdd.CommandType = CommandType.StoredProcedure;
            d.cmdd.CommandText = "cabintablXCOPY1";
        ...
        int pagenumber = 1;
        IPagedList<tablXCOPY1> list;
        public async Task<IPagedList<tablXCOPY1>> GetPagedListAsync(int pageNumber = 1, int pageSize = 5000)
        {
            return await Task.Factory.StartNew(() =>
            {
                using (allcopoy1 db = new allcopoy1())
                {
                    return db.tablXCOPY1.OrderBy(p => p.id).ToPagedList(pageNumber, pageSize);
                }
            }
            );
        }
        ...
        private void citytablx()
        {
            ...
            d.cmdd.Parameters.Clear();
            d.cmdd.CommandType = CommandType.StoredProcedure;
            d.cmdd.CommandText = "citystblxCOPY1";
