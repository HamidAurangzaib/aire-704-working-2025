...
namespace aire
{
    public partial class Search_Jet2holidays : Form
    {
        public Search_Jet2holidays()
        {
            InitializeComponent();
        }
        ado d = new ado();

        private void Search_Jet2holidays_Load(object sender, EventArgs e)
        {
            ...
            d.connecter();
            d.dt.Rows.Clear();
            d.da = new SqlDataAdapter("select * from nameJET2HOLIDAYS", d.cn);
            d.ds = new DataSet();
            int count;
            d.da.Fill(d.ds, "hldy");
        ...
        private void fnctionSreach(string nameProc, string value1, string value2, int nbr1, int nbr2)
        {
            ...
            for (int i = 0; i < cnt; i++)
            {
                ...
                dataGridView2.Rows.Add(d.dt.Rows[i][0].ToString(), d.dt.Rows[i][1].ToString(), d.dt.Rows[i][2].ToString(), d.dt.Rows[i][3].ToString(),
                      ...
                      d.dt.Rows[i][15].ToString(), d.dt.Rows[i][16].ToString(), d.dt.Rows[i][17].ToString(), "", DateTime.Parse(d.dt.Rows[i][19].ToString()), d.dt.Rows[i][18].ToString());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                fnctionSreach("affichFromToJET2", textBox1.Text, textBox2.Text, 0, 0);
            }
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                fnctionSreach("SearchMonthFromToJET2", textBox11.Text, textBox10.Text, 6, 0);
            }
            else if (radioButton2.Checked == true)
            {
                fnctionSreach("SearchDateFromToJET2", textBox11.Text, textBox10.Text, 7, 0);
            }
        }

        private void button2_Click(object sender, EventArgs e)
        {
            fnctionSreach("SearchDateJET2", dateTimePicker1.Value.ToString("yyyy/MM/dd"), "", 1, 0);

        }

        private void button7_Click(object sender, EventArgs e)
        {
            fnctionSreach("SearchHotelNameJET2", textBox9.Text, "", 2, 0);
        }

        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox1.Text != "0")
                fnctionSreach("SearchStarJET2", comboBox1.Text, "", 3, 0);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                fnctionSreach("SearchPriceJET2", textBox3.Text, textBox4.Text, 4, 1);
            }

            else if (radioButton3.Checked == true)
            {
                fnctionSreach("SearchPriceJET2", textBox3.Text, textBox4.Text, 4, 2);
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (textBox5.Text != "" && textBox6.Text != "")
                fnctionSreach("SearchPriceWithFromToJET2", textBox7.Text, textBox8.Text, 5, 0);
        }
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                dataGridView2.Columns[19].DefaultCellStyle.SelectionForeColor = Color.Blue;
                dataGridView2.Columns[19].DefaultCellStyle.SelectionBackColor = Color.White;
                dataGridView2.Columns[19].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                if (e.RowIndex > -1)
                {
        ...
        {
            upload_holiday up = new upload_holiday("JET2HOLIDAYS");
            up.Show();
        }
                    ...
                    if (textBox16.Text != "")
                    {
                        if (textBox17.Text != "")
                        {
                            if (textBox18.Text != "")
                            {
                                ...
                                fnctionSreach("SearchPriceWithFromToStarTransfersForJet2Holidays", textBox12.Text, textBox13.Text, 8, 0);
                            }
                            else
                            {
                                textBox18.Text = "0";
                ...
                else if (textBox13.Text != "" && textBox12.Text == "")
                {
                    if (textBox16.Text != "")
                    {
                        if (textBox17.Text != "")
                        {
                            if (textBox18.Text != "")
                            {
                                fnctionSreach("SearchPriceWithFromToStarTransfersForJet2Holidays", "", textBox13.Text, 8, 0);
                            }
                            else
                            {
                                textBox18.Text = "0";
                ...
                else if (textBox12.Text != "" && textBox13.Text == "")
                {
                    if (textBox16.Text != "")
                    {
                        if (textBox17.Text != "")
                        {
                            if (textBox18.Text != "")
                            {
                                fnctionSreach("SearchPriceWithFromToStarTransfersForJet2Holidays", textBox12.Text, "", 8, 0);
                            }
                            else
                            {
                                textBox18.Text = "0";
