...
namespace aire
{
    public partial class upload_gf_domestic_target : Form
    {
        OleDbConnection con;
        DataTable dt;
        DataTable dt1;
        public upload_gf_domestic_target()
        {
            InitializeComponent();
        }
        ado d = new ado();
        private void datatarget()
        {
            ...
            d.ds = new DataSet();
            d.da = new SqlDataAdapter("select * from tblGfDomesticTarget", d.cn);
            d.ds = new DataSet();
        ...
        private void upload_gf_domestic_target_Load(object sender, EventArgs e)
        {
            d.connecter();
            datatarget();
        ...
        {
            if (textBox1.Text == "" || textBox2.Text == "" || textBox3.Text == "" || textBox6.Text == "" || comboBox2.Text == "")
            {
            ...
            else
            {
                ...
                //dr[0] is id column
                dr[1] = textBox1.Text; //tblGfDomesticTarget table column: 2 => dr[1]
                dr[2] = textBox2.Text;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                d.cmdd.CommandText = "CheckGfDomesticTargetRecordExistence";
                ...
                d.cmdd.Parameters.Add("@days", SqlDbType.VarChar).Value = comboBox2.Text;
                ...
                if (recordCount > 0)
                {
                    ...
                    d.cmdd.CommandText = "deleteSingleGfDomesticTarget";
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            ...
            if (op.ShowDialog() == DialogResult.OK)
            {
                ...
                //d.cmdd = new SqlCommand("delete tblGfDomesticTarget", d.cn);
                //d.cmdd.ExecuteNonQuery();
                ...
                await Task.Run(() => {
                    ...
                    {
                        j++;
                        sql += "insert into tblGfDomesticTarget  values ('" + dt.Rows[i]["FROM"].ToString() + "','" + dt.Rows[i]["TO"].ToString() + "','"  + dt.Rows[i]["FROM DATE"].ToString() + "','" + dt.Rows[i]["TO DATE"].ToString() + "','" + dt.Rows[i]["PRICE"].ToString() + "','" + dt.Rows[i]["AIRCODE"].ToString() + "','" + dt.Rows[i]["CABIN"].ToString() + "','" + dt.Rows[i]["STOPS"].ToString() + "','" + dt.Rows[i]["DAYS"].ToString() + "')";
                        if (j == 10001)
                        {
                            b++;
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            // Get the value from the DataGridView and set it in the ComboBox
            string selectedValue = dataGridView1.Rows[index].Cells[9].Value.ToString();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                d.cmdd.Parameters.Clear();
                d.cmdd.CommandType = CommandType.StoredProcedure;
                d.cmdd.CommandText = "CheckGfDomesticTargetRecordExistenceById";
                ...
                {
                    // Record exists, proceed with deletion
                    d.cmdd.CommandText = "UpdateGfDomesticTarget";
