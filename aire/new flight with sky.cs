...
namespace aire
{
    public partial class new_flight_with_sky : Form
    {
        ado d = new ado();
        public new_flight_with_sky()
        {
            InitializeComponent();
        }
        ...
        private void comb()
        {
            d.da = new SqlDataAdapter("select distinct [From] from newskyflight", d.cn);
            d.da.Fill(d.ds, "com1");
            d.da = new SqlDataAdapter("select distinct [To] from newskyflight", d.cn);
            d.da.Fill(ds1, "com2");
        ...
        private void new_flight_with_sky_Load(object sender, EventArgs e)
        {
            d.connecter();

                d.cmdd = new SqlCommand("exec insertnewskyflight", d.cn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                searchFROMTO(textBox1.Text,textBox2.Text, "serchFromTonewskyflight");

                datagridvColor();
            }
            else if (textBox1.Text != "" && textBox2.Text == "")
            {
                searchFROMTO(textBox1.Text,"","serchFromnewskyflight");
                datagridvColor();
            }
            else if (textBox1.Text == "" && textBox2.Text != "")
            {
                searchFROMTO("", textBox2.Text, "serchTonewskyfligh");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            d.cmdd.Parameters.Clear();
            d.cmdd.CommandType = CommandType.StoredProcedure;
            d.cmdd.CommandText = "datenewskyflight";
            ...
            if (minPrice.Text != "" || maxprice.Text != "")
            {
                if (checkBox7.Checked == true )
                {
                    if (radioButton1.Checked == true)
                    {
                        ...
                        price(float.Parse(minPrice.Text), 99999, "pricenewskyflight1");
                    ...
                    else if (radioButton2.Checked == true)
                    {
                        ...
                        price(float.Parse(minPrice.Text), 99999, "pricenewskyflightlow");
                        datagridvColor();
                    ...
                    else if (radioButton3.Checked == true)
                    {
                        ...
                        price(float.Parse(minPrice.Text), float.Parse(maxprice.Text), "pricenewskyflight");
                 ...
                 if ( checkBox8.Checked == true)
                {
                    ...
                    if (radioButton1.Checked == true)
                    {
                        ...
                        price(float.Parse(minPrice.Text), 99999, "diffnewskyflight1");
                    ...
                    else if (radioButton2.Checked == true)
                    {
                        ...
                        price(float.Parse(minPrice.Text), 99999, "diffnewskyflightlow");
                    ...
                    else if (radioButton3.Checked == true)
                    {
                        ...
                        price(float.Parse(minPrice.Text),float.Parse(maxprice.Text), "diffnewskyflight");
            ...
            if (textBox1.Text != "" && textBox2.Text != "")
            {
                if (checkBox7.Checked == true)
                {
                    if (radioButton1.Checked == true)
                    {
                        if (minPrice.Text != "")
                        {
                            ...
                            price_place(textBox1.Text, textBox2.Text, float.Parse(minPrice.Text), 99999, "serchFromTopricenewskyflighbig");
                    ...
                    else if (radioButton2.Checked == true)
                    {
                        if (minPrice.Text != "")
                        {
                            price_place(textBox1.Text, textBox2.Text, float.Parse(minPrice.Text), 99999, "serchFromTopricenewskyfligh");
                    ...
                    else if (radioButton3.Checked == true)
                    {
                        if (minPrice.Text != "" && maxprice.Text != "")
                        {
                            ...
                            price_place(textBox1.Text, textBox2.Text, float.Parse(minPrice.Text), float.Parse(maxprice.Text), "serchFromTopricenewskyflighbetween");
                ...
                if (checkBox8.Checked==true)
                {
                    ...
                    if (radioButton1.Checked == true)
                    {
                        if (minPrice.Text != "")
                        {
                            price_place(textBox1.Text, textBox2.Text, float.Parse(minPrice.Text), 99999, "serchFromTopricenewskyflighbig2");
                    ...
                    else if (radioButton2.Checked == true)
                    {
                        ...
                        if (minPrice.Text != "")
                        {
                            ...
                            price_place(textBox1.Text, textBox2.Text, float.Parse(minPrice.Text), 99999, "serchFromTopricenewskyfligh2");
                    ...
                    else if (radioButton3.Checked == true)
                    {
                        if (minPrice.Text != "" && maxprice.Text != "")
                        {
                            ...
                            price_place(textBox1.Text, textBox2.Text, float.Parse(minPrice.Text), float.Parse(maxprice.Text), "serchFromTopricenewskyflighbetween2");
        ...
        int pagenumber = 1;
        IPagedList<newskyflight> list;
        public async Task<IPagedList<newskyflight>> GetPagedListAsync(int pageNumber = 1, int pageSize = 5000)
        {
            return await Task.Factory.StartNew(() =>
            {
                using (quicknewEntities db = new quicknewEntities())
                {
                    return db.newskyflights.OrderBy(p => p.id).ToPagedList(pageNumber, pageSize);
                }
            }
            );
        }
        ...
        private void citynexgfsky()
        {
            ...
            d.cmdd.Parameters.Clear();
            d.cmdd.CommandType = CommandType.StoredProcedure;
            d.cmdd.CommandText = "citysGFSKYS";
